        ...
        props.results.map((elem,i) =>{
            ...
            return(
                ...
                <div key={i} className="card">
                    ...
                    <h5 className="mt-4">Author: {elem.volumeInfo.authors?elem.volumeInfo.authors[0]:"Anonymous"}</h5>
                    <p><img src={elem.volumeInfo.imageLinks? elem.volumeInfo.imageLinks.thumbnail:"https://via.placeholder.com/150X150"} alt="book" className="pr-3 float-left"/>{elem.volumeInfo.description}</p>
